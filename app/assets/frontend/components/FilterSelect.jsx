...
var FilterSelect = React.createClass({
  getInitialState: function() {
    return {
      selected: {value: 'Filter by Specialty', label: 'Filter by Specialty', slug: ''}
    }
  },
  ...
  clearFilters: function(e) {
    e.preventDefault();
    this.props.filterSpecialty('clear');
    this.setState({selected: {value: 'Filter by Specialty', label: 'Filter by Specialty', slug: ''}})
  },
  render: function() {
    var options = [
      {
    ...
    return (
      <div className="header-filter col s6">
        <div className="input-field col s8">
          <Dropdown options={options} onChange={this.filterSpecialty} value={defaultOption} />
        </div>
        <a href="" className="clear-filters col s4" onClick={this.clearFilters}>Clear Filters</a>
      </div>
    )
  }
});
